    ...
    function DashboardViewModel() {
       ...
       */
        ...
        self.submitRow = (key) => {                                       
            ...
            $.ajax({                    
              type: "PUT",
              url: ko.dataFor(document.getElementById('globalBody')).serviceContext + "/clients/update",                                        
              dataType: "json",      
        ...
        self.deleteRow = (key) => {                                       
            ...
            $.ajax({                    
              type: "DELETE",
              url: ko.dataFor(document.getElementById('globalBody')).serviceContext + "/clients/delete/" + key,                                        
              dataType: "json",                    
              //crossDomain: true,
              contentType : "application/json",                    
              success: function() {                    
        ...
        self.createClient = function (event, data) {
            ...
            $.ajax({                    
                type: "POST",
                url: ko.dataFor(document.getElementById('globalBody')).serviceContext + "/clients/new",                                        
                dataType: "json",      
